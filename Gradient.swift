...
class Gradient {
    ...
    init() {
        self.colorSets["day"] = [changeToCGColor(hexcode: "4097E8"), changeToCGColor(hexcode: "FFCF40")]
        self.colorSets["night"] = [changeToCGColor(hexcode: "2B1678"), changeToCGColor(hexcode: "03002F")]
        self.colorSets["dawn"] = [changeToCGColor(hexcode: "EB4E00"), changeToCGColor(hexcode: "EBED00")]
    }
